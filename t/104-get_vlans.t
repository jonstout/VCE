...
ok($vlans->{'results'}->[0]->{'vlans'}->[2]->{'vlan_id'} eq '979f9708-7102-4762-8a6a-8e30ed80b88c', "First vlan returned properly");
# eth0/2 is owned by ajco; This means all VLANs that use this port must be returned by GET VLANs.
ok($vlans->{'results'}->[0]->{'vlans'}->[0]->{'vlan_id'} eq '2806baa4-173c-4bdd-b552-c063a82e232f', "Second vlan returned properly");
ok($vlans->{'results'}->[0]->{'vlans'}->[1]->{'vlan_id'} eq 'b0c0103e-b2dc-47cd-a687-c73dd9100fd2', "Third vlan returned properly");
